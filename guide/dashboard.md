...
En la parte superior del Dashboard se muestra un banner de bienvenida personalizado con el nombre del usuario que ha iniciado sesión.

<ImagePlaceholder label="Banner de bienvenida del Dashboard" />
