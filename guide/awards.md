...
<ImagePlaceholder label="Pantalla de configuración de premios de una aventura" />
...
<ImagePlaceholder label="Lista de posiciones con medallas de oro, plata y bronce" />
